...
/*
Anything the keyboard is trying to send to the computer is sent through the data
register. The keyboard raises IRQ1 when it has data available for reading.
*/
